package com.example.myjualangrup
    ...
    override fun onClick(v: View?) {
        when (v?.id){
            R.id.btn_move_jualan1 -> {
                val moveJualan1 = Intent(this@MainActivity, MoveJualan1::class.java)
                startActivity(moveJualan1)
            }
            R.id.btn_move_jualan_ke2 -> {
                val moveJualan2 = Intent(this@MainActivity, MoveJualan2::class.java)
